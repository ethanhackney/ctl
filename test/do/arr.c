...
int arr_test_struct_cmp(const struct arr_test_struct a, const struct arr_test_struct b)
{
...
int arr_test_union_cmp(const union arr_test_union a, const union arr_test_union b)
{
	return s64_cmp(a.a, b.a);
}
